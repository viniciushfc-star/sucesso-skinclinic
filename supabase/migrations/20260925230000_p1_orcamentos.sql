-- Orçamentos no paciente. Idempotente. Cole no SQL Editor.
...
COMMENT ON TABLE public.orcamentos IS 'Proposta comercial da clínica. Aceite grava no paciente; não altera preço sozinho.';
