-- FASE 5: CPF só enquanto o cadastro está incompleto; portal não grava notes internas.
...
BEGIN
  ...
  -- p_notes é ignorado de propósito: não mistura relato do titular com notes da clínica.
