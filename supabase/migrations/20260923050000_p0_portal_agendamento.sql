-- P0-2 FASE 9: agendamento do portal em migration oficial.
-- Colunas só IF NOT EXISTS. Não cria a tabela agenda.
-- Choque de horário usa duração, não só o mesmo minuto.
