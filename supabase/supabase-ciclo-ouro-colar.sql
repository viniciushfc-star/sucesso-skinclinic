-- Elo orçamento → pacote (sem duplicar). Cole e Run.
...
COMMENT ON COLUMN public.client_packages.orcamento_id IS 'Orçamento que gerou o pacote. Aceite repetido não cria outro.';
